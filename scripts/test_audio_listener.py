...
async def test_audio_listener():
    ...
    try:
        ...
        #     samplerate=audio_listener.sample_rate,
        #     blocksize=audio_listener.chunk_size,
        #     dtype="int16",
        #     channels=audio_listener.channels,
        #     callback=audio_listener._audio_callback
        # ):
            # 启动音频监听
            print("开始音频监听...")
...
if __name__ == "__main__":
    try:
        asyncio.run(test_audio_listener())
    except Exception as e:
        print(f"主程序发生错误: {e}") 